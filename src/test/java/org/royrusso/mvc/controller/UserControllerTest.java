...
@ContextConfiguration({ "classpath:test-context.xml", "classpath:mock-test-beans.xml" })
public class UserControllerTest {
	...
	public void testUpdate() throws Exception {
		mockMvc.perform(put("/user").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(new User())))
				.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(jsonPath("success", is(true)));
	}
